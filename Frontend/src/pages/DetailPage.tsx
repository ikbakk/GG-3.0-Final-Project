...
const DetailPage = () => {
  return (
    <div className="flex h-full w-full flex-col justify-between gap-4 overflow-auto p-4 md:flex-row">
      <div className="flex h-full w-full flex-col items-center gap-4 md:w-3/5 lg:w-4/5">
        <MediaPlayer />
        <ProductsContainer />
      </div>
      <div className="flex h-full w-full flex-col gap-4 md:w-2/5 lg:w-1/5">
        <Comments />
        <CommentForm />
      </div>
    </div>
